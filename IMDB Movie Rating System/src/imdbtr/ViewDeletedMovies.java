...
// Servlet Name 
@WebServlet("/ViewDeletedMovies") 
public class ViewDeletedMovies extends HttpServlet { 
	...
	{ 
		...
		java.util.Arrays.fill(moviedesc[i], null);
			...
			Statement stmt=con.createStatement();
			 ...
			 rs = stmt.executeQuery("Select * from deleted_movies");
		...
		//	 String passwordfinal = null;
			 ...
			 while ( rs.next() ) {
	           ...
	           //     System.out.println("in while2");
	                ...
	                String rating = rs.getString("changedat");
...
//			 }
			...
			OutputStatement="<html><body><head>\r\n" + 
					...
					"</head>"
					+ "<form name=\"myForm\" id=\"myForm\" action=\"adminalter.jsp\" method=\"POST\"> <center>\r\n" + 
					"	<div class=\"form-area\"><h2><font color=\"white\">Deleted movies</font></h2><table border=2px><tr><td> <font color=\"white\">Movie ID\t</font></td><td><font color=\"white\">Movie Name\t</font></td><td><font color=\"white\">DELETED TIME</font></td></tr>";
			for(i=0;moviedesc[i][0]!=null;i++)
				 {
